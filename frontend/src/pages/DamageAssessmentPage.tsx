...
export default function DamageAssessmentPage() {
  ...
  const runInference = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Something went wrong while running the assessment. Please try again.');
    } finally {
      setRunning(false);
    }
  };
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '32px 24px 64px' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 13, color: MUTED, margin: 0, maxWidth: 600 }}>
            Upload before-and-after satellite images of a location to assess the extent of structural damage.
          </p>
        </div>
